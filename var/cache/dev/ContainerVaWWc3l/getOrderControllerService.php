...
class getOrderControllerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator..RZCLtu'] ?? $container->load('get_ServiceLocator__RZCLtuService'))->withContext('App\\Controller\\OrderController', $container));
